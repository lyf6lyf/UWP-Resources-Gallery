...
namespace UWPResourcesGallery.Pages
{
    ...
    /// </summary>
    public sealed partial class WinUIBrushesPage : Page
    {

        private readonly WinUIBrushItemSource source = new WinUIBrushItemSource();

        public WinUIBrushesPage()
        {
            InitializeComponent();
            Loaded += LoadSystemColors;
            Analytics.TrackEvent("Visited: WinUIBrushesPage");
        }
